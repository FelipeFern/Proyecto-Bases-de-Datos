		...
		try {
			...
			}
			{
				...
				}
				{
					...
					lblAcercaDe3.setText(
							"<html><center>Bases de Datos<br/>Elementos de Bases de Datos<br/>Teoría y Diseño de Bases de Datos<br/>");
				...
				}
				{
					...
					lblAcercaDe4.setText(
							"<html><center>Dpto. de Ciencias e Ingeniería de la Computación<br/>Universidad Nacional del Sur");
					lblAcercaDe4.setHorizontalAlignment(SwingConstants.CENTER);
				}
				dlgAcercaDeLayout.setHorizontalGroup(dlgAcercaDeLayout.createSequentialGroup().addContainerGap(62, 62)
						.addGroup(dlgAcercaDeLayout.createParallelGroup()
								.addGroup(dlgAcercaDeLayout.createSequentialGroup()
										.addComponent(lblAcercaDe3, GroupLayout.PREFERRED_SIZE, 367,
												GroupLayout.PREFERRED_SIZE)
										.addGap(0, 0, Short.MAX_VALUE))
								.addGroup(dlgAcercaDeLayout.createSequentialGroup()
										.addComponent(lblAcercaDe4, GroupLayout.PREFERRED_SIZE, 367,
												GroupLayout.PREFERRED_SIZE)
										.addGap(0, 0, Short.MAX_VALUE))
								.addGroup(dlgAcercaDeLayout.createSequentialGroup()
										.addComponent(lblAcercaDe1, GroupLayout.PREFERRED_SIZE, 367,
												GroupLayout.PREFERRED_SIZE)
										.addGap(0, 0, Short.MAX_VALUE))
								.addGroup(dlgAcercaDeLayout.createSequentialGroup().addGap(127)
										.addGroup(dlgAcercaDeLayout.createParallelGroup()
												.addGroup(GroupLayout.Alignment.LEADING,
														dlgAcercaDeLayout.createSequentialGroup()
																.addComponent(btnCerrar, GroupLayout.PREFERRED_SIZE,
																		104, GroupLayout.PREFERRED_SIZE)
																.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED,
																		0, Short.MAX_VALUE))
												.addGroup(dlgAcercaDeLayout.createSequentialGroup()
														.addComponent(lblAcercaDe2, GroupLayout.PREFERRED_SIZE, 108,
																GroupLayout.PREFERRED_SIZE)
														.addGap(0, 0, Short.MAX_VALUE)))
										.addGap(132)))
						.addContainerGap(212, 212));
				dlgAcercaDeLayout
						.setVerticalGroup(dlgAcercaDeLayout.createSequentialGroup().addContainerGap()
								.addComponent(lblAcercaDe1, GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE)
								.addGap(22)
								.addComponent(lblAcercaDe2, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE,
										GroupLayout.PREFERRED_SIZE)
								...
								.addGap(24).addComponent(btnCerrar, GroupLayout.PREFERRED_SIZE,
